...
public class Ball : MonoBehaviour {
    ...
    private float playerPaddleHeight, playerPaddleWidth, computerPaddleHeight, computerPaddleWidth,
        playerPaddleMaxX, playerPaddleMaxY, playerPaddleMinX, playerPaddleMinY, computerPaddleMaxX,
        computerPaddleMaxY, computerPaddleMinX, computerPaddleMinY, ballWidth, ballHeight;
    ...
    bool CheckCollision() {
        ...
        if (transform.localPosition.x - ballWidth / 2 + 0.05 < playerPaddleMaxX && transform.localPosition.x + ballWidth / 2 - 0.05 > playerPaddleMinX) {
            if (transform.localPosition.y - ballHeight / 2 + 0.05 < playerPaddleMaxY && transform.localPosition.y + ballHeight / 2 - 0.05 > playerPaddleMinY) {
        ...
        if (transform.localPosition.x + ballWidth / 2 - 0.05 > computerPaddleMaxX && transform.localPosition.x - ballWidth / 2 + 0.05 < computerPaddleMinX) {
            if (transform.localPosition.y - ballHeight / 2 + 0.05 < computerPaddleMaxY && transform.localPosition.y + ballHeight / 2 - 0.05 > computerPaddleMinY) {
